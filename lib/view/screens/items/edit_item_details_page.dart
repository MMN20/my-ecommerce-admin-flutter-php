...
import 'package:my_ecommerce_admin/controllers/items/edit_item_details_page_controller.dart';
...
class EditItemDetailsPage extends StatelessWidget {
  const EditItemDetailsPage({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(EditItemDetailsPageController());
    return Scaffold(
      appBar: AppBar(
        actions: [
          IconButton(
